...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Logdo') }}| Bringing back the fun in loggin</title>
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <x-jet-nav-link href="/apps" :active="request()->routeIs('app')">
                                    Apps
                                </x-jet-nav-link>
                                <x-jet-nav-link href="/docs" :active="request()->routeIs('docs')">
                                    Docs
                                </x-jet-nav-link>
                            </div>
                        </div>
